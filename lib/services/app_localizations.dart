...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'zh': {
      ...
      'reset_link_sent_desc': '若此信箱已經註冊，重設密碼連結將會寄至您的信箱。',
    ...
    'en': {
      ...
      'calendar_view_agenda': 'Agenda List',
      ...
      'reset_link_sent_desc': 'If this email is registered, a password reset link will be sent to your inbox.',
